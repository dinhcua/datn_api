...
exports.seedingOrganField = void 0;
const client_1 = require("@prisma/client");
const convertData_1 = require("./convertData");
const seedingOrganField = async () => {
    ...
    const organizationsSeedingData = (0, convertData_1.convertData)(organizationsSeeding);
    ...
    const groupSeedingData = (0, convertData_1.convertData)(groupData, "id_organization");
    ...
    const fieldsSeedingData = (0, convertData_1.convertData)(fieldsSeeding);
    ...
    const orFieldSeedingData = (0, convertData_1.convertData)(orFieldSeeding, "id_organization", "id_field");
    await prisma.organization_field.createMany({ data: orFieldSeedingData });
    console.log("finish seeding organization and field");
};
exports.seedingOrganField = seedingOrganField;
